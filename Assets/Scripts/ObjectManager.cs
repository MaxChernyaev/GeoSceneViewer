...
public class ObjectManager : MonoBehaviour
{
    ...
    private void LoadObject()
    {
        ...
        // Запускаю Intersection() после установки всей сцены, чтобы вывести расстояние от начала профиля до объекта
        GameObject.Find("Main Camera").GetComponent<ARSceneMakingManager>().FindProfile();
        GameObject.Find("Main Camera").GetComponent<ARSceneMakingManager>().Intersection();
